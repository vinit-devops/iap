...
| --- | ---------------------------------- | ---------------------------------------- | ----- | ------- | ------------ | ------------------------------------------------------- |
| 1   | Amazon S3                          | `ObjectStore`                            | live  | pre-v4; M22.1 | **live-proven** | `jarvis-1784216247` · m22.1-s3-public-live-run-evidence.md |
| 2   | Amazon SQS                         | `Queue`                                  | live  | pre-v4; M22.1 | **live-proven** | `jarvis-1784216417` · m22.1-sqs-dlq-live-run-evidence.md |
...
| 5   | AWS Secrets Manager                | `Secret`                                 | A     | M21.2   | **live-proven** | `jarvis-1784205298` · m21.2-secrets-manager-live-run-evidence.md |
| 6   | AWS Certificate Manager            | Gateway-derived → `Certificate` (1.1.0)  | A     | M21.2 / M23.2 | **live-proven** (ISSUED justified-partial) | `jarvis-1784205607` · m21.2-acm-live-run-evidence.md; `jarvis-1784345755` · m23.2-acm-issued-live-run-evidence.md (DNS-validation wiring live; ISSUED needs a delegated domain) |
| 7   | Amazon ECS                         | `Service`                                | A     | M21.3   | **live-proven** | `jarvis-1784207615` · m21.3-ecs-live-run-evidence.md |
| 8   | Application Load Balancer          | `Gateway`                                | A     | M21.3 (TG M21.2) | **live-proven** | `jarvis-1784208415` · m21.3-alb-live-run-evidence.md; `jarvis-1784206236` · m21.2-target-group-live-run-evidence.md |
| 9   | Amazon RDS                         | `Database`                               | A     | M21.3   | **live-proven** | `jarvis-1784210467` · m21.3-rds-live-run-evidence.md |
| 10  | Amazon ElastiCache                 | `Cache`                                  | A     | M21.3 (Memcached M22.3) | **live-proven** | `jarvis-1784208612` · m21.3-elasticache-live-run-evidence.md; `jarvis-1784338126` · m22.3-elasticache-memcached-live-run-evidence.md |
| 11  | AWS Lambda                         | `Function`                               | B     | M22.1   | **live-proven** | `jarvis-1784216685` · m22.1-lambda-live-run-evidence.md |
| 12  | Amazon API Gateway                 | `Gateway`                                | B     | M22.1   | **live-proven** | `jarvis-1784216685` · m22.1-apigateway-live-run-evidence.md |
| 13  | Amazon SNS                         | `Topic`                                  | B     | M22.1   | **live-proven** | `jarvis-1784215942` · m22.1-sns-live-run-evidence.md |
| 14  | AWS SSM Parameter Store            | `Secret`                                 | B     | M22.1   | **live-proven** | `jarvis-1784216089` · m22.1-ssm-parameter-live-run-evidence.md |
| 15  | Amazon EventBridge Scheduler       | `Job` (cron)                             | B     | M22.1   | **live-proven** | `jarvis-1784216685` · m22.1-scheduler-live-run-evidence.md |
| 16  | Amazon CloudWatch Logs             | derived (log posture)                    | B     | M22.1   | **live-proven** | `jarvis-1784216173` · m22.1-cloudwatch-logs-live-run-evidence.md |
| 17  | Amazon DynamoDB                    | `Database`                               | B     | M22.2   | **live-proven** (mandated replacement executed live) | `jarvis-1784279604` · m22.2-dynamodb-live-run-evidence.md |
...
| 19  | AWS KMS                            | derived (encryption posture)             | B     | M22.2   | **live-proven** | `jarvis-1784279606` · m22.2-kms-live-run-evidence.md |
| 20  | AWS Backup                         | derived (backup posture)                 | B     | M22.2   | **live-proven** | `jarvis-1784279607` · m22.2-backup-live-run-evidence.md |
| 21  | Amazon Aurora                      | `Database`                               | B     | M22.3   | **live-proven** | `jarvis-1784307755` · m22.3-aurora-live-run-evidence.md |
| 22  | Amazon DocumentDB                  | `Database`                               | B     | M22.3   | **live-proven** | `jarvis-1784307756` · m22.3-docdb-live-run-evidence.md |
| 23  | Amazon Neptune                     | `Database`                               | B     | M22.3   | **live-proven** | `jarvis-1784338123` · m22.3-neptune-live-run-evidence.md |
| 24  | Amazon MemoryDB                    | `Cache`                                  | B     | M22.3   | **live-proven** | `jarvis-1784338124` · m22.3-memorydb-live-run-evidence.md |
| 25  | Amazon MQ                          | `Queue`, `Topic`                         | B     | M22.3   | **live-proven** (2 live bugs fixed) | `jarvis-1784338125` · m22.3-mq-live-run-evidence.md |
| 26  | Amazon EBS                         | `Volume`                                 | B     | M22.4   | **live-proven** | `jarvis-1784289033` · m22.4-ebs-live-run-evidence.md |
| 27  | Amazon EFS                         | `Volume`                                 | B     | M22.4   | **live-proven** (1 live bug fixed) | `jarvis-1784289034` · m22.4-efs-live-run-evidence.md |
| 28  | Amazon FSx                         | `Volume`                                 | B     | M22.4   | **live-proven** | `jarvis-1784338127` · m22.4-fsx-live-run-evidence.md |
| 29  | Amazon EC2                         | `Service` (vm)                           | B     | M22.5   | **live-proven** (1 live bug fixed) | `jarvis-1784289036` · m22.5-ec2-live-run-evidence.md |
| 30  | Amazon EC2 Auto Scaling            | `Service` (scaling)                      | B     | M22.5   | **live-proven** (dependsOn ordering proven live) | `jarvis-1784289037` · m22.5-asg-live-run-evidence.md |
| 31  | AWS App Runner                     | `Service`                                | B     | M22.5   | **live-proven** (HTTP 200 live) | `jarvis-1784338128` · m22.5-apprunner-live-run-evidence.md |
| 32  | AWS Batch                          | `Job`                                    | B     | M22.5   | **live-proven** (1 live bug fixed) | `jarvis-1784289039` · m22.5-batch-live-run-evidence.md |
| 33  | Network Load Balancer              | `Gateway`                                | B     | M22.5   | **live-proven** | `jarvis-1784289040` · m22.5-nlb-live-run-evidence.md |
| 34  | AWS WAF (WAFv2)                     | derived (public `Gateway` posture)       | B     | M22.5   | **live-proven** | `jarvis-1784289041` · m22.5-waf-live-run-evidence.md |
| 35  | Amazon Route 53                    | `DnsZone` (1.1.0)                         | C     | M23.2   | **live-proven** | `jarvis-1784345750` · m23.2-route53-live-run-evidence.md |
| 36  | Amazon ECR                         | `Registry` (1.1.0)                       | C     | M23.2   | **live-proven** | `jarvis-1784345751` · m23.2-ecr-live-run-evidence.md |
| 37  | Amazon CloudWatch                  | `Alert` + `Dashboard` (1.1.0)            | C     | M23.2   | **live-proven** | `jarvis-1784345752` · m23.2-cloudwatch-live-run-evidence.md |
| 38  | Amazon Keyspaces                   | `Database` (wide-column, 1.1.0)          | C     | M23.2   | **live-proven** | `jarvis-1784345753` · m23.2-keyspaces-live-run-evidence.md |
| 39  | Amazon Redshift Serverless         | `Database` (warehouse, 1.1.0)            | C     | M23.2   | **live-proven** | `jarvis-1784345754` · m23.2-redshift-serverless-live-run-evidence.md |
| 40  | Amazon VPC                         | `Network` (1.2.0)                        | C     | M23.4   | **live-proven** (full VPC graph up/down) | `jarvis-1784349970` · m23.4-network-workflow-live-run-evidence.md |
| 41  | AWS Step Functions                 | `Workflow` (1.2.0)                       | C     | M23.4   | **live-proven** (Express SM SUCCEEDED) | `jarvis-1784349970` · m23.4-network-workflow-live-run-evidence.md |
| 42  | Amazon Kinesis (Streams+Firehose)  | `Stream` (1.2.0)                         | C     | M23.5   | **live-proven** | `jarvis-1784351929` · m23.5-kinesis-live-run-evidence.md; `jarvis-1784351930` · m23.5-firehose-live-run-evidence.md |
...
| 44  | Amazon OpenSearch Service          | `SearchIndex` (1.2.0)                    | C     | M23.5   | **live-proven** | `jarvis-search-1931` · m23.5-opensearch-live-run-evidence.md |
| 45  | Amazon CloudFront                  | `Cdn` (new, 1.3.0)                       | D     | M24.2   | **live-proven** (Deployed; disable-then-delete) | `jarvis-1784356903` · m24.2-cloudfront-live-run-evidence.md |
| 46  | Amazon EventBridge                 | `EventBus` (new, 1.3.0)                  | D     | M24.2   | **live-proven** | `jarvis-1784356901` · m24.2-eventbridge-live-run-evidence.md |
| 47  | Amazon Cognito                     | `Identity` (user-directory, 1.3.0)       | D     | M24.2   | **live-proven** (secret-replace live, zero leak) | `jarvis-1784356902` · m24.2-cognito-live-run-evidence.md |
