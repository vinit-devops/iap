...
| `valid/02-relationships.iap.yaml`               | pass (warning IAP801 for the reserved `Alert` kind is expected and permitted)                            |
...
- all three `cases/valid/*` files → **valid**
- `invalid/01`, `invalid/02`, `invalid/03`, `invalid/06` → **invalid**
- `invalid/04`, `invalid/05`, `invalid/07`–`invalid/22` → **valid** (their failures are semantic; see below)
